...
<a class="d-flex align-items-center p-2"  href="login.php?logout=true">
  <i class="fas fa-sign-out-alt me-2"></i>Logout
                ...
                <a href="javascript:void(0);"><i class="ti ti-user"></i><span>Students</span><span class="menu-arrow"></span></a>
						...
						<li>
							...
							<li class="submenu">
								...
								<li  class="active"><a href="addclassroom.php"><i class="ti ti-building"></i><span>Class Room</span></a></li>
            ...
            <div class="content">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between mb-3">
                    <div class="my-auto mb-2">
                        <h3 class="page-title mb-1">Classrooms List</h3>
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="javascript:void(0);">Classrooms</a>
                                </li>
                    ...
                    <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
                        ...
                        <div class="mb-2">
                            <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_classroom"><i class="fas fa-plus-square me-2"></i>Add Classroom</a>
                        </div>
                    </div>
                </div>
                <!-- /Page Header -->
                    ...
                    <div class="card-header d-flex align-items-center justify-content-between flex-wrap pb-0">
                        ...
                        <div class="d-flex align-items-center flex-wrap">
                            ...
                            <div class="dropdown mb-3">
                                ...
                                <subst class="dropdown-menu p-3" aria-labelledby="sortDropdown">
                                    <li><a href="#" class="dropdown-item rounded-1 active" data-sort="asc">Sort A-Z (Classroom Name)</a></li>
                                    <li><a href="#" class="dropdown-item rounded-1" data-sort="desc">Sort Z-A (Classroom Name)</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <?php if (!empty($classrooms)): ?>
                                        <?php foreach ($classrooms as $classroom): ?>
                                            <tr>
                                                <td>
                                                    <div class="form-check form-check-md">
                                                        <input class="form-check-input" type="checkbox" name="select_classroom[]" value="<?= htmlspecialchars($classroom['id']) ?>">
                                                    </div>
                                                </td>
                                                <td><?= htmlspecialchars($classroom['id']) ?></td>
                                                <td><?= htmlspecialchars($classroom['nom']) ?></td>
                                                <td>
                                                    <button class="btn btn-sm btn-primary btn-edit-classroom" data-id="<?= htmlspecialchars($classroom['id']) ?>" data-nom="<?= htmlspecialchars($classroom['nom']) ?>">Edit</button>
                                                    <button class="btn btn-sm btn-danger btn-delete-classroom" data-id="<?= htmlspecialchars($classroom['id']) ?>">Delete</button>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php else: ?>
        ...
        <!-- Add Classroom Modal -->
        <div class="modal fade" id="add_classroom" tabindex="-1" aria-hidden="true">
                    ...
                    <div class="modal-body">
                        <form id="classroomForm" action="" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="nom" placeholder="Enter Classroom Name" required>
                            </div>
        ...
        <div class="modal fade" id="editClassroomModal" tabindex="-1" aria-labelledby="editClassroomLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="editClassroomName" name="nom" required>
                            </div>
                            <div id="editMessage" style="margin-top: 10px;"></div>
                        </div>
                        <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"  style="margin-right: 275px;">Cancel</button>
            ...
            <div class="modal-dialog">
                <form id="deleteClassroomForm" method="post" action="">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"  style="margin-right: 275px;">No, Cancel</button>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.btn-edit-classroom').forEach(btn => {
                btn.addEventListener('click', () => {
                    ...
                    document.getElementById('editClassroomName').value = nom;
            ...
            document.querySelectorAll('.btn-delete-classroom').forEach(btn => {
                btn.addEventListener('click', () => {
                    const id = btn.dataset.id;
                    document.getElementById('deleteClassroomId').value = id;
                    deleteModal.show();
                });
            });
            ...
            document.getElementById('editClassroomForm').addEventListener('submit', function(e) {
                ...
                .then(data => {
                    editMessage.innerHTML = `<p style='color:${data.status === 'success' ? 'green' : 'red'}'>${data.message}</p>`;
            ...
            // Handle Delete Classroom Form Submission
            document.getElementById('deleteClassroomForm').addEventListener('submit', function(e) {
                ...
                .then(response => response.json())
                .then(data => {
                    deleteMessage.innerHTML = `<p style='color:${data.status === 'success' ? 'green' : 'red'}'>${data.message}</p>`;
                    if (data.status === 'success') {
                        setTimeout(() => {
                            deleteModal.hide();
                            location.reload();
            ...
            document.querySelectorAll('.dropdown-item').forEach(item => {
                item.addEventListener('click', e => {
                    ...
                    if (sortLabel) {
                        sortLabel.textContent = sortOrder === 'asc' ? 'Sort A-Z (Classroom Name)' : 'Sort Z-A (Classroom Name)';
                    }
                    ...
                    rows.sort((a, b) => {
                        const valueA = a.cells[2].textContent.trim().toLowerCase();
                        const valueB = b.cells[2].textContent.trim().toLowerCase();
